...
namespace FamilyBudget {
    ...
    public partial class SampleDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomerRow AddCustomerRow(int ID, string Day, string Month, string Money) {
        ...
        public partial class CustomerRow : global::System.Data.DataRow {
            ...
            public string Money {
                get {
                    try {
                        return ((string)(this[this.tableCustomer.MoneyColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Money\' in table \'Customer\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableCustomer.MoneyColumn] = value;
                }
            }
            ...
            public bool IsMoneyNull() {
                return this.IsNull(this.tableCustomer.MoneyColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetMoneyNull() {
                this[this.tableCustomer.MoneyColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace FamilyBudget.SampleDatabaseDataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customer] WHERE (([ID] = @Original_ID) AND ([Day] = @Original_" +
                "Day) AND ([Month] = @Original_Month) AND ((@IsNull_Money = 1 AND [Money] IS NULL" +
                ") OR ([Money] = @Original_Money)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customer] ([ID], [Day], [Month], [Money]) VALUES (@ID, @Day, @" +
                "Month, @Money);\r\nSELECT ID, Day, Month, Money FROM Customer WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [ID] = @ID, [Day] = @Day, [Month] = @Month, [Money] = @Money WHERE (([ID] = @Original_ID) AND ([Day] = @Original_Day) AND ([Month] = @Original_Month) AND ((@IsNull_Money = 1 AND [Money] IS NULL) OR ([Money] = @Original_Money)));
SELECT ID, Day, Month, Money FROM Customer WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::FamilyBudget.Properties.Settings.Default.SampleDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Day, Month, Money FROM dbo.Customer";
        ...
        public virtual int Delete(int Original_ID, string Original_Day, string Original_Month, string Original_Money) {
        ...
        public virtual int Insert(int ID, string Day, string Month, string Money) {
        ...
        public virtual int Update(int ID, string Day, string Month, string Money, int Original_ID, string Original_Day, string Original_Month, string Original_Money) {
            ...
            if ((Original_Money == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_Money));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Day, string Month, string Money, int Original_ID, string Original_Day, string Original_Month, string Original_Money) {
            return this.Update(Original_ID, Day, Month, Money, Original_ID, Original_Day, Original_Month, Original_Money);
        }
    }
